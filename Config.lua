...
local Config = {
    ...
    panel = {
        ...
        controls = {
            ...
            closeButtonAtlas = "auctionhouse-ui-filter-redx",
            closeButtonOffsetX = -1,
    ...
    search = {
        ...
        maxResults = 20,
        settingsStyleDropdownOffsetY = 2,
        settingsStyleDropdownLeftInset = 2,
        historyLimit = 10,
        ...
        appearance = {
            ...
            styles = {
                ...
                rightInset = 8,
                verticalInset = 2,
                blizzardAtlas = "common-searchbar-a",
                blizzardHeight = 30,
                blizzardSearchIconSize = 14,
                blizzardClearButtonSize = 19,
                blizzardClearIconSize = 11,
                blizzardLeftOutset = 0,
            },
            defaultOpacity = 1,
            minOpacity = 0.2,
            maxOpacity = 1,
