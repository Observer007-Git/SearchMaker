...
SMK.PinTextures = {
    ...
    { id = 3, atlas = "Ping_Map_Whole_Warning" },
    { id = 4, atlas = "Ping_Map_Whole_Assist" },
    { id = 5, atlas = "VignetteEvent-SuperTracked" },
    { id = 6, atlas = "ElementalStorm-Lesser-Fire" },
    { id = 7, atlas = "MonsterFriend" },
    { id = 8, atlas = "PlayerPartyBlip" },
    ...
    { id = 15, atlas = "CrossedFlags" },
    { id = 16, atlas = "Professions_Tracking_Fish_Special" },
    { id = 17, atlas = "Map-MarkedDefeated" },
    { id = 18, atlas = "ElementalStorm-Boss-Fire" },
    { id = 19, atlas = "XMarksTheSpot" },
    { id = 20, atlas = "MiniMap-DeadArrow" },
}
